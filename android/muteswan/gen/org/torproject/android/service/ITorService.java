 ...
 * Original file: /Users/rob/git/android/muteswan/src/org/torproject/android/service/ITorService.aidl
 */
...
case TRANSACTION_updateTransProxy:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.updateTransProxy();
reply.writeNoException();
...
/**
    ...
    */
public boolean updateTransProxy() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_updateTransProxy, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_updateTransProxy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_updateConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
